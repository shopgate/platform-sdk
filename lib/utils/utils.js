...
function setProcessFile (processName, dir) {
  fsEx.writeFileSync(path.join(dir, processName), {running: true})
}

function isProcessRunning (processName, dir) {
  return fsEx.pathExistsSync(path.join(dir, processName))
}
...
module.exports = { resetProject, setProcessFile, isProcessRunning, deleteProcessFile }
