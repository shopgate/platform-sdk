...
class BackendAction {
  ...
  static register (caporal) {
    caporal
      ...
      .option('--inspect-extensions', 'allow inspection tools to connect for the debugging of backend extensions')
   ...
   * @param {Boolean} cliOptions.inspectExtensions
   */
  run (cliOptions) {
    ...
    this.backendProcess = new BackendProcess(
      ...
      this.appSettings,
      logger,
      new StepExecutor(logger, this.appSettings, cliOptions.inspectExtensions)
    )
