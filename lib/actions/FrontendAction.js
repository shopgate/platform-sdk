...
class FrontendAction {
  ...
  static register (caporal, appSettings, userSettings) {
    caporal
      ...
      .action((args, options) => new FrontendAction(appSettings, userSettings).run('start', args, options))

    caporal
      .command('frontend setup')
      .description('Changes the settings for the frontend development')
      .action((args, options) => new FrontendAction(appSettings, userSettings).run('setup', args, options))
  }
