...
class ExtensionAction {
  ...
  static register (caporal, appSettings, userSettings, dcHttpClient) {
    ...
    caporal
      ...
      .option('-i, --poll-interval', t('EXT_UPLOAD_POLL_INTERVAL_DESCRIPTION'), caporal.INT, 3000)
      .action(async (args, options) => {
    ...
    caporal
      ...
      .option('-i, --poll-interval', t('THEME_UPLOAD_POLL_INTERVAL_DESCRIPTION'), caporal.INT, 3000)
      .action(async (args = {}, options = {}) => {
