...
class ExtensionAction {
  ...
  static register (caporal, appSettings, userSettings) {
    caporal
      ...
      .action((args, options) => new ExtensionAction(appSettings, userSettings).createExtension(args, options))
    ...
    caporal
      ...
      .action((args) => new ExtensionAction(appSettings, userSettings).attachExtensions(args))
    ...
    caporal
      ...
      .action((args) => new ExtensionAction(appSettings, userSettings).detachExtensions(args))
  }
