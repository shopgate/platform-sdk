...
class ExtensionAction {
  ...
  attachExtensions (extensions) {
    ...
    extensions.forEach((extensionFolderName) => {
      ...
      if (!extensionId) {
        return logger.warn(`There is not extension in the folder ./extensions/${extensionFolderName}. Skip. Please make sure that you only pass the folder name of the extension as argument.`)
      }
