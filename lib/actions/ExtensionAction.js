...
class ExtensionAction {
  ...
  _updateBackendFiles (userInput, state) {
    ...
    promises.push(fsEx.move(path.join(pipelineDirPath, 'awesomeOrganization.awesomePipeline.v1.json'), path.join(pipelineDirPath, `${userInput.organizationName}.awesomePipeline.json`)))
