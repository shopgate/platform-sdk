...
function login (options, cb) {
  getUsernameAndPassword(options, (username, password) => {
...
function getUsernameAndPassword (options, cb) {
  let username = options.username || process.env.SGCLOUD_USER
  let password = options.password || process.env.SGCLOUD_PASS
