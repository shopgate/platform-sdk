...
class AppSettings {
  ...
  async attachExtension (pathName, extensionInfo, force) {
    ...
    try {
      ...
      logger.warn('attachedExtensions.json not found; creating...')
      extensions = {}
    }
  ...
  /**
   * @returns {Promise<Object>} A key-value hash with extension IDs as key and extension configurations as values.
   * @throws {Error} if this.attachedExtensionsFile is not present.
   */
