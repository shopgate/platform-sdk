  ...
  setRoutes (callback) {
    ...
    request.get(`${this.rapidUrl}/status`, (err, res) => {
      ...
      this.rapidApi.init(() => {
        ...
        this.server.options('/', (req, res, next) => res.send(200))
         ...
         */
        this.server.options('/web_storage', (req, res, next) => res.send(200))
        this.server.post('/web_storage', commandApi)

        /**
         * Open a special endpoint for sendHttpRequest commands.
         */
        this.server.options('/http_request', (req, res, next) => res.send(200))
