...
class FrontendSetup {
  ...
  async save (answers) {
    ...
    await frontendSettings.setIpAddress(answers.startpageIp)
  ...
  async getDefaultConfig () {
    ...
    return {
      ...
      startpageIp: startpageIp || getLocalIpAddress(),
      port: port || 8080,
      apiPort: apiPort || 9666,
      hmrPort: hmrPort || 3000,
      remotePort: remotePort || 8000,
      sourceMapsType: sourceMapsType || 'eval-cheap-module-source-map'
    }
  }
}
