...
class FrontendSettings {
   ...
   */
  getApiPort () {
    return this.loadSettings().apiPort
  }
   ...
   */
  getHmrPort () {
    return this.loadSettings().hmrPort
  }
   ...
   */
  getRemotePort () {
    return this.loadSettings().remotePort
  }
   ...
   */
  getAccessToken () {
    return this.loadSettings().accessToken
  }
   ...
   */
  getSourceMapsType () {
    return this.loadSettings().sourceMapsType
  }
