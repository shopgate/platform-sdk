...
const { getLocalIpAddress } = require('../../utils/utils')
...
class FrontendSettings {
   ...
   */
  async setStartpageIpAddress (startpageIp = getLocalIpAddress()) {
    const settings = (await this.loadSettings())
   ...
   * @param {string} [sourceMapsType='eval-cheap-module-source-map'] The source maps type.
   */
  async setSourceMapsType (sourceMapsType = 'eval-cheap-module-source-map') {
    const settings = (await this.loadSettings())
